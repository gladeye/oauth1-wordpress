...
// Create server
$server = new Gladeye\OAuth1\Client\Server\Wordpress(array(
    'identifier' => 'DcFqsxc4uY9V',
    'secret' => 'Lyh1mMFsjbOW8H4aJHFl6TFVK4uL4CitSuXj7R3wdDidLr7n',
    'callback_uri' => "http://oauth1-wordpress.ken.gld/wordpress.php",
    'base' => "http://media.ken.gld/core"
));
...
// Step 3
    ...
    header("Location: http://{$_SERVER['HTTP_HOST']}/wordpress.php?user=user");
    exit;
// Step 2
